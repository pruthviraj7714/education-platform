        ...
        <div className="bg-background-light | min-h-screen | pt-8">
            <div className="bg-background p-[40px] rounded-[10px] shadow max-w-[540px] mx-auto">
                <div className="text-start">
                    <h2 className="text-4xl text-secondary font-[550] leading-[46px]">Sign Up</h2>
                    <p className="text-secondary-light mt-[6px] leading-[25px] text-[18px] font-normal">
                        Sign up and begin your {selectedRole === 'mentor' ? 'mentoring' : 'learning'} journey.
                    </p>
                </div>
                    ...
                    <FormProvider {...methods}>
                        <form onSubmit={methods.handleSubmit(onSubmit)} className="max-w-md mx-auto">
                            ...
                            {methods.formState.errors.name && (
                                <p className="text-primary mb-5">{methods.formState.errors.name.message}</p>
                            )}
                            ...
                            {methods.formState.errors.email && (
                                <p className="text-primary mb-5">{methods.formState.errors.email.message}</p>
                            )}
                            ...
                            <div className="mt-6 flex items-center justify-center gap-2">
                                ...
                                <div className="text-primary flex items-center cursor-pointer">
                                    <p onClick={() => navigate('/')}>Login</p> <MdArrowOutward size={24} />
                                </div>
                            </div>
                        </form>
                    </FormProvider>
