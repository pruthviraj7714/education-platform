...
import { FaUser, FaEnvelope, FaBirthdayCake, FaVenusMars, FaUserTag } from 'react-icons/fa';
...
const ProfilePage: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await axios.put('https://login-service-phi.vercel.app/v1/user/updateProfile', updatedData, {
                headers: {
    ...
    const handleAddSkill = (e: React.KeyboardEvent<HTMLInputElement>) => {
        if (e.key === 'Enter' && addSkills.trim() !== '') {
            e.preventDefault();
            setSkills(prevSkills => [...new Set([...prevSkills, addSkills.trim()])]);
            setAddSkills('');
        }
    };
        ...
        <div className="bg-[#f7f7f8] min-h-screen px-[20px] sm:px-[60px]">
            ...
            <div className="w-full">
                <div className='flex justify-between items-center pt-[30px]'>
                    <h2 className="text-[24px] leading-[33px] font-semibold text-[#191919]">Profile Details</h2>
                    {!isEditing && (
                        <Button onClick={startEditing} variant='outlined' className='flex items-center'>
                ...
                {isEditing ? (
                    <div className="bg-white rounded-lg shadow-md mt-4 p-6">
                        ...
                        <div className="flex justify-end mt-4">
                            <Button onClick={() => setIsEditing(false)} variant='outlined' className='mr-4'>
                                Cancel
                            </Button>
                            ...
                            <div className="flex items-start border p-4 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-800 font-medium">
                                        {user?.roles && user.roles.length > 0 ? user.roles[0] : 'Role not available'}
                                    </p>
                                </div>
                            </div>
                        </div>
